...
<body>
    ...
    <div class="login-section">          
        <div class="form-block">                    
            <div class="form-block__bg" style="background: url(img/sign-up.jpeg)"><span class="form-block__bg_text">LOG <br>IN</span></div>
            <form action="" class="form" id="login-form"  novalidate="">
